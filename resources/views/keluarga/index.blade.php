                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        @forelse($keluargas as $k)
                            <tr class="hover:bg-gray-50/50 dark:hover:bg-[#18181b] transition-colors">
                                ...
                                <td class="px-6 py-4 text-right space-x-2">
                                    <button @click="openEditModal({{ json_encode($k) }})" class="text-blue-600 hover:text-blue-800 dark:text-blue-500 dark:hover:text-blue-400 font-medium text-sm">
                                        Edit
                                    </button>
                                    <button @click="confirmDelete('{{ url('/keluarga') }}/{{ $k->id }}')" class="text-red-600 hover:text-red-800 dark:text-red-500 dark:hover:text-red-400 font-medium text-sm">
                                        Hapus
                                    </button>
                                </td>
                            </tr>
                                ...
                                <template x-for="k in selectedPegawai.keluargas" :key="k.id">
                                    <tr class="hover:bg-gray-50/50 dark:hover:bg-[#18181b] transition-colors">
                                        ...
                                        <td class="px-4 py-3 text-right space-x-2">
                                            <button @click="openEditModal(k)" class="text-blue-600 hover:text-blue-800 font-medium text-xs">Edit</button>
                                            <button @click="confirmDelete('{{ url('/keluarga') }}/' + k.id)" class="text-red-600 hover:text-red-800 font-medium text-xs">Hapus</button>
                                        </td>
                                    </tr>
                                </template>
                            </template>
