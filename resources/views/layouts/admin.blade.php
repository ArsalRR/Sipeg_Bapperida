...
<body class="bg-[#f8fafc] dark:bg-[#0a0a0a] text-slate-800 dark:text-slate-200 font-sans antialiased flex h-screen overflow-hidden transition-colors duration-300 isolate">
    ...
    <!-- Sidebar Overlay (Mobile only) : z-20, di bawah header & modal -->
    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden relative">
        ...
        <!-- Top Header : solid background + border + z-20, supaya konten yang di-scroll di <main> tidak tembus -->
        <header class="h-20 flex items-center justify-between px-6 lg:px-10 shrink-0 z-20 bg-[#f8fafc]/90 dark:bg-[#0a0a0a]/90 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 transition-colors duration-300">
        ...
        <!-- Main Area : konten discroll di sini, di bawah header secara z-index maupun DOM order -->
